...
export const resume = {
  ...
  meta: {
    siteTitle: "이지혜 포트폴리오",
    siteDescription:
      "Full-Side Product Engineer 이지혜 포트폴리오 — 기획 · UX 설계 · 개발",
  ...
  career: {
    summary:
      "20년 이상 기획·PM·개발을 넘나들며 서비스를 만들어온 Full-Side 엔지니어",
    experiences: [
      {
        id: "exp-1",
        company: "(주)마타에듀",
  ...
  Project: {
    ...
    cases: [
      ...
      },
      {
        ...
        execution:
          "React, TypeScript, Styled-Components, React-Query, Storybook",
        tools: "GitLab, Jira",
        year: "2014 ~ 2022",
        role: "프론트엔드 개발",
        images: [],
