...
├── app/
│   ├── layout.tsx
│   ├── page.tsx           # 단일 페이지 메인 — 모든 섹션 포함 (Hero → About → Impact → Contact)
...
3️⃣ /content-setup         ← 콘텐츠 확인 (resume.ts 필수, 누락 섹션 자동 보완)
   ↓
4️⃣ /sample-page-create    ← 섹션 컴포넌트 생성 (Hero, About, Projects, Impact, Contact)
...
| 4   | `/sample-page-create` | 섹션 컴포넌트 자동 생성 (Hero/About/Projects/Impact/Contact) | 10분      |
